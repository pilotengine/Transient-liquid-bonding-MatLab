...
nu=50; %number of coordinate point (length of base metal 6025/elemental thickness 25)+1
...
plot(t((0.1*10^5):(120*10^5)),s((0.1*10^5):(120*10^5)))
grid
xlabel('t')
ylabel('s')
title('s(t)')
